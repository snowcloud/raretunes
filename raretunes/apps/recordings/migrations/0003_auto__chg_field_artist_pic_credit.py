...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Artist.pic_credit'
        db.alter_column('recordings_artist', 'pic_credit', self.gf('django.db.models.fields.TextField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Artist.pic_credit'
        db.alter_column('recordings_artist', 'pic_credit', self.gf('django.db.models.fields.CharField')(max_length=48, null=True))
